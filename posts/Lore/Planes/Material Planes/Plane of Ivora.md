One of the 12 material planes in [[Drakensveil]] 

```leaflet  
id: MapCalcExample ### Must be unique with no spaces  
image: [[Ivora.png]] ### Link to the map image file. Do not add a ! in front of the image  
bounds: [[0,0], [2000, 4000]] ### Size of the map in px Height_y, Width_x. Ignore 0,0  
height: 350px ### Size of the leaflet embed in px on your screen  
...
defaultZoom: -2.6 ### Sets the default zoom level when the map loads. Hover over the target icon to see the current level.  
